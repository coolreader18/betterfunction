...
var grammar = {
    ...
    {"name": "pos", "symbols": ["int", {"literal":" "}, "int", {"literal":" "}, "int"]},
    {"name": "pos$macrocall$2", "symbols": [{"literal":"~"}]},
    {"name": "pos$macrocall$1$ebnf$1", "symbols": ["int"], "postprocess": id},
    {"name": "pos$macrocall$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pos$macrocall$1$ebnf$2", "symbols": ["int"], "postprocess": id},
    {"name": "pos$macrocall$1$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pos$macrocall$1$ebnf$3", "symbols": ["int"], "postprocess": id},
    {"name": "pos$macrocall$1$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pos$macrocall$1", "symbols": ["pos$macrocall$2", "pos$macrocall$1$ebnf$1", {"literal":" "}, "pos$macrocall$2", "pos$macrocall$1$ebnf$2", {"literal":" "}, "pos$macrocall$2", "pos$macrocall$1$ebnf$3"]},
    {"name": "pos", "symbols": ["pos$macrocall$1"]},
    {"name": "pos$macrocall$4", "symbols": [{"literal":"^"}]},
    {"name": "pos$macrocall$3$ebnf$1", "symbols": ["int"], "postprocess": id},
    {"name": "pos$macrocall$3$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pos$macrocall$3$ebnf$2", "symbols": ["int"], "postprocess": id},
    {"name": "pos$macrocall$3$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pos$macrocall$3$ebnf$3", "symbols": ["int"], "postprocess": id},
    {"name": "pos$macrocall$3$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "pos$macrocall$3", "symbols": ["pos$macrocall$4", "pos$macrocall$3$ebnf$1", {"literal":" "}, "pos$macrocall$4", "pos$macrocall$3$ebnf$2", {"literal":" "}, "pos$macrocall$4", "pos$macrocall$3$ebnf$3"]},
    {"name": "pos", "symbols": ["pos$macrocall$3"]},
    ...
    {"name": "nspStatement$macrocall$1$ebnf$1$subexpression$1", "symbols": ["_", "nspStatement$macrocall$2", "between"], "postprocess": data => data[1]},
    ...
    {"name": "nspStatement$macrocall$1", "symbols": [{"literal":"{"}, "between", "nspStatement$macrocall$1$ebnf$1", "_", {"literal":"}"}], "postprocess": data => data[2]},
    ...
    {"name": "folderStatement$macrocall$1$ebnf$1$subexpression$1", "symbols": ["_", "folderStatement$macrocall$2", "between"], "postprocess": data => data[1]},
    ...
    {"name": "folderStatement$macrocall$1", "symbols": [{"literal":"{"}, "between", "folderStatement$macrocall$1$ebnf$1", "_", {"literal":"}"}], "postprocess": data => data[2]},
    ...
    {"name": "functionBlock$macrocall$1$ebnf$1$subexpression$1", "symbols": ["_", "functionBlock$macrocall$2", "between"], "postprocess": data => data[1]},
    ...
    {"name": "functionBlock$macrocall$1", "symbols": [{"literal":"{"}, "between", "functionBlock$macrocall$1$ebnf$1", "_", {"literal":"}"}], "postprocess": data => data[2]},
    {"name": "functionBlock", "symbols": ["functionBlock$macrocall$1"], "postprocess": data => data[0].map(id)},
    {"name": "between$ebnf$1", "symbols": []},
    {"name": "between$ebnf$1$subexpression$1$ebnf$1", "symbols": ["comment"], "postprocess": id},
    {"name": "between$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "between$ebnf$1$subexpression$1", "symbols": ["_", "between$ebnf$1$subexpression$1$ebnf$1", "nl"]},
    ...
    {"name": "comment$subexpression$1", "symbols": [{"literal":"#"}]},
    ...
    {"name": "comment", "symbols": ["comment$subexpression$1", "nnl+"]},
